...
function toggle_payload(pld){
	if(pld == "exploit"){
		...
		document.getElementById("progress").innerHTML="Loading Silver755x82-v2.0.. Please wait..";
		preloadScripts(['Silver755.js','jsloader.js']);
	}else if(pld == "Silver755x82-1.2"){
		document.getElementById("progress").innerHTML="Loading Silver755x82-v1.2.. Please wait..";
		...
		document.getElementById("progress").innerHTML="Loading Payload.. Please wait..";
		preloadScripts(['dumper.js','jsloader.js']);
